    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 modal-overlay bg-black bg-opacity-90">
      <div className="bg-game-blue border-4 border-game-gold rounded-lg max-w-md w-full mx-4 p-6 shadow-2xl transform transition-all">
        <div className="text-center">
          ...
          <div className="bg-black bg-opacity-80 rounded-lg p-6 mb-6 banker-offer-animation animate-pulse border border-game-gold/50">
            <p className="text-5xl font-heading font-black text-game-gold mb-1">
              {formatCurrency(offer)}
            </p>
            <p className="text-gray-300 text-sm">Based on remaining cases</p>
          </div>
